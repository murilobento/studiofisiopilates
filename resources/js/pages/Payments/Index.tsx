...
import { Eye, DollarSign, XCircle, CheckCircle, Plus, Filter, Search, AlertTriangle } from 'lucide-react';
...
interface MonthlyPayment {
    ...
    formatted_reference_month?: string; // Adicionado o accessor que vem do backend
    paid_at: string | null;
...
export default function PaymentsIndex() {
    ...
    const columns: ColumnDef<MonthlyPayment>[] = [
        ...
        },
        {
            ...
            header: 'Mês/Ano',
            cell: ({ row }) => {
                // Tenta usar o accessor formatted_reference_month se disponível
                if (row.original.formatted_reference_month) {
                    return row.original.formatted_reference_month;
                }
                // Caso contrário, usa a função formatMonth
                return formatMonth(row.original.reference_month);
            },
        },
        {
            accessorKey: 'amount',
    ...
    return (
        <AppLayout>
            ...
            <div className="flex h-full flex-1 flex-col gap-4 p-4 sm:gap-6 sm:p-6">
                ...
                <Dialog open={showPaymentDialog} onOpenChange={setShowPaymentDialog}>
                    <DialogContent>
                        <DialogHeader>
                            ...
                            <DialogDescription>
                                Selecione o método de pagamento e preencha os detalhes para confirmar o pagamento da mensalidade.
                            </DialogDescription>
                        </DialogHeader>
                ...
                {/* AlertDialog para Desfazer Pagamento */}
                    ...
                    <AlertDialogContent>
                        <AlertDialogHeader>
                            ...
                            <AlertDialogDescription>
                                Tem certeza que deseja desfazer este pagamento? O status voltará para pendente.
                            </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
                            <AlertDialogCancel>Cancelar</AlertDialogCancel>
                            <AlertDialogAction onClick={confirmUndoPayment}>Confirmar</AlertDialogAction>
                        </AlertDialogFooter>
                    </AlertDialogContent>
                </AlertDialog>
                ...
                <AlertDialog open={showUndoCancelDialog} onOpenChange={setShowUndoCancelDialog}>
                    <AlertDialogContent>
                        ...
                        <AlertDialogFooter>
                            <AlertDialogCancel>Cancelar</AlertDialogCancel>
                            <AlertDialogAction onClick={confirmUndoCancel}>Confirmar</AlertDialogAction>
                        </AlertDialogFooter>
                    </AlertDialogContent>
                </AlertDialog>
            </div>
