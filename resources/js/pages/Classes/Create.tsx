...
import { ArrowLeft, AlertTriangle, BookOpen, Clock, Users, Calendar } from 'lucide-react';
...
export default function Create({ instructors, can }: ClassesCreateProps) {
    ...
    React.useEffect(() => {
        ...
        if (qsStart) {
            ...
            if (!qsEnd && !data.end_time) {
                ...
                setData('end_time', toLocalDateTime(startDate));
            }
        }
    ...
    const checkTimeConflict = async (instructorId: string, startTime: string, endTime: string) => {
        ...
        try {
            console.log('Verificando conflito:', { instructorId, startTime, endTime });
    ...
    const handleStartTimeChange = (value: string) => {
        ...
        if (value && !data.end_time) {
            ...
            startDate.setHours(startDate.getHours() + 1);
            const endTime = toLocalDateTime(startDate);
            ...
            <div className="flex h-full flex-1 flex-col gap-6 p-6">
                ...
                <div className="flex flex-col gap-2">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h1 className="text-3xl font-bold tracking-tight">Nova Aula</h1>
                ...
                <form onSubmit={submit} className="space-y-6">
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Defina o título e instrutor da aula
                            </CardDescription>
                        </CardHeader>
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Configure data e horário da aula
                            </CardDescription>
                        </CardHeader>
                        <CardContent className="space-y-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                ...
                                <div>
                                    ...
                                    <p className="text-sm text-muted-foreground mt-1">
                                        Horário de fim será preenchido automaticamente (+1h)
                                    </p>
                                </div>
                            </div>
